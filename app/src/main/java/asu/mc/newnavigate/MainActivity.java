...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void submitReport(View v){
        Toast.makeText(this, "Reported Crime", Toast.LENGTH_LONG).show();
    }

    public void reportSuspect(View v){
        Toast.makeText(this, "Reported Suspect", Toast.LENGTH_LONG).show();
    }
...
//        hf.setLatLong(end_latitude, end_longitude);
//        hf.setLatLongCurr(latitude, longitude);
//        hf.onClick(v);
